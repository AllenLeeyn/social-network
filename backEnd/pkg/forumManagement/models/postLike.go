...
func InsertPostLike(db *dbTools.DBContainer, postLike *PostLike) (int, error) {
...
func UpdateStatusPostLike(db *dbTools.DBContainer, post_like_id int, status string, user_id int) error {
...
func ReadAllPostsLikes(db *dbTools.DBContainer) ([]PostLike, error) {
	// Query the records
...
func ReadPostsLikeByUserId(db *dbTools.DBContainer, userId int) ([]PostLike, error) {
	// Query the records
	rows, selectError := db.Conn.Query(`
        SELECT 
			pl.id as post_like_id, pl.type, pl.status as post_like_status, pl.created_at as post_like_created_at, pl.updated_at as post_like_updated_at, pl.updated_by as post_like_updated_by,
...
func ReadPostsLikeByPostId(db *dbTools.DBContainer, postId int) ([]PostLike, error) {
	// Query the records
	rows, selectError := db.Conn.Query(`
        SELECT 
			pl.id as post_like_id, pl.type, pl.status as post_like_status, pl.created_at as post_like_created_at, pl.updated_at as post_like_updated_at, pl.updated_by as post_like_updated_by,
...
func PostHasLiked(db *dbTools.DBContainer, userId int, postID int) (int, string) {
